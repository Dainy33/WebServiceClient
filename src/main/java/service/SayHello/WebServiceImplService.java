 ...
 * 
 */
@WebServiceClient(name = "WebServiceImplService", targetNamespace = "http://impl.service.practice.dainy33.com/", wsdlLocation = "http://localhost:8989/WS_Server/WebService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName WEBSERVICEIMPLSERVICE_QNAME = new QName("http://impl.service.practice.dainy33.com/", "WebServiceImplService");
    ...
    public WebServiceImpl getWebServiceImplPort() {
        return super.getPort(new QName("http://impl.service.practice.dainy33.com/", "WebServiceImplPort"), WebServiceImpl.class);
    }
    ...
    public WebServiceImpl getWebServiceImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://impl.service.practice.dainy33.com/", "WebServiceImplPort"), WebServiceImpl.class, features);
    }
